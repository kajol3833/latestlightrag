...
export const getDocuments = async (): Promise<DocsStatusesResponse> => {
  const response = await axiosInstance.get(backendBaseUrl+'/documents')
  return response.data
}

export const scanNewDocuments = async (): Promise<{ status: string }> => {
  const response = await axiosInstance.post(backendBaseUrl+'/documents/scan')
  return response.data
}

export const getDocumentsScanProgress = async (): Promise<LightragDocumentsScanProgress> => {
  const response = await axiosInstance.get(backendBaseUrl+'/documents/scan-progress')
  return response.data
}
...
export const insertText = async (text: string): Promise<DocActionResponse> => {
  const response = await axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/documents/text`, { text })
  return response.data
}

export const insertTexts = async (texts: string[]): Promise<DocActionResponse> => {
  const response = await axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/documents/texts`, { texts })
  return response.data
}
...
export const uploadDocument = async (
  ...
  const response = await axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/documents/upload`, formData, {
    headers: {
...
export const clearDocuments = async (): Promise<DocActionResponse> => {
  const response = await axiosInstance.delete(`${import.meta.env.VITE_BACKEND_URL}/documents`)
  return response.data
}
...
export const clearCache = async (modes?: string[]): Promise<{
  ...
  const response = await axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/documents/clear_cache`, { modes })
  return response.data
}

export const deleteDocuments = async (docIds: string[], deleteFile: boolean = false): Promise<DeleteDocResponse> => {
  const response = await axiosInstance.delete(`${import.meta.env.VITE_BACKEND_URL}/documents/delete_document`, {
...
export const getAuthStatus = async (): Promise<AuthStatusResponse> => {
  try {
    ...
    const response = await axiosInstance.get(`${import.meta.env.VITE_BACKEND_URL}/auth-status`, {
...
export const getPipelineStatus = async (): Promise<PipelineStatusResponse> => {
  const response = await axiosInstance.get(`${import.meta.env.VITE_BACKEND_URL}/documents/pipeline_status`)
  return response.data
}
...
export const loginToServer = async (username: string, password: string): Promise<LoginResponse> => {
  ...
  const response = await axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/login`, formData, {
    headers: {
      'Content-Type': 'multipart/form-data'
    }
  });
...
export const updateEntity = async (
  ...
  const response = await axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/graph/entity/edit`, {
...
export const updateRelation = async (
  ...
  const response = await axiosInstance.post(`${import.meta.env.VITE_BACKEND_URL}/graph/relation/edit`, {
...
export const checkEntityNameExists = async (entityName: string): Promise<boolean> => {
  try {
    const response = await axiosInstance.get(`${import.meta.env.VITE_BACKEND_URL}/graph/entity/exists?name=${encodeURIComponent(entityName)}`)
